...
- (void)viewDidLoad{
    ...
    [self setupBaseNavViewControllreClass:@"IMHomeController"
                          selectImageName:@"wifi_btn"
                        unSelectImageName:@"wifi"
                                    title:@"会话"];
    [self setupBaseNavViewControllreClass:@"IMContactsController"
                          selectImageName:@"faxian_btn"
                        unSelectImageName:@"faxian"
                                    title:@"联系人"];
    [self setupBaseNavViewControllreClass:@"IMSettingController"
